...
@section('title')
 <img src="{{ asset('assets/img/washing-machine.png') }}" alt="Laundry Logo"  height="70" > <b>Login Laundry</b>
@endsection
...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
       ...
       <a class="small" href="/register">Doesn't have account? Register now</a>
